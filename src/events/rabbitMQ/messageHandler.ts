  ...
  static async handle(
    ...
    try {
      switch (operation) {
        ...
        case "activate":
          response = await userController.activateUser.bind(userController)(
            data
          );
          break;
        ...
        case "update-course-list":
          response = await userController.updateCourseList.bind(userController)(
            data
          );
          break;

        case "verify-instructor":
          response = await userController.verifyInstructor.bind(userController)(
            data.id
          );
          break;

        case "block-user":
          response = await userController.blockUser.bind(userController)(
            data.id
          );
          break;
